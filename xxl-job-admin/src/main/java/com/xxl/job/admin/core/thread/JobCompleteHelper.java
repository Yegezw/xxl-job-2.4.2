...
public class JobCompleteHelper
{
    ...
    public void start()
    {
        ...
        callbackThreadPool = new ThreadPoolExecutor(
                ...
                r -> new Thread(r, "xxl-job, admin JobLostMonitorHelper-callbackThreadPool-" + r.hashCode()),
                (r, executor) ->
                {
                    r.run();
                ...
                () ->
                {
                    ...
                    while (!toStop)
                    {
                        try
                        {
                            ...
                            List<Long> lostJobIds = XxlJobAdminConfig.getAdminConfig().getXxlJobLogDao().findLostJobIds(lostTime);
